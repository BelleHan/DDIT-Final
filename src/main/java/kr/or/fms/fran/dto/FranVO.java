...
public class FranVO {
	...
	private float fran_latitude;		//위도
	private float fran_longitude;		//경도
	...
	public float getFran_latitude() {
		return fran_latitude;
	}
	public void setFran_latitude(float fran_latitude) {
		this.fran_latitude = fran_latitude;
	}
	public float getFran_longitude() {
		return fran_longitude;
	}
	public void setFran_longitude(float fran_longitude) {
		this.fran_longitude = fran_longitude;
	}
