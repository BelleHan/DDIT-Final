...
public class SupGoodsModifyCommand {

	private String sup_goods_code;
	private String sup_goods_name;
	private int sup_goods_price;
	...
	private MultipartFile sup_goods_img;
	...
	public MultipartFile getSup_goods_img() {
		return sup_goods_img;
	}

	public void setSup_goods_img(MultipartFile sup_goods_img) {
	...
	public SupGoodsVO toParseGoods() {
		...
		supGoods.setSup_goods_price(this.sup_goods_price);
