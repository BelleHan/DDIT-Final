...
public class FranStChangeRegistCommand {
	...
	public FranStChangeVO toFranStChangeVO() {
		FranStChangeVO stVO = new FranStChangeVO();
		stVO.setFran_code(this.fran_code);
		stVO.setAppli_st(this.appli_st);
		stVO.setSt_change_start(this.st_change_start);
		stVO.setSt_change_end(this.st_change_end);
		stVO.setSt_change_reason(this.st_change_reason);
		return stVO;
	}
