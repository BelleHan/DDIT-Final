...
<div class="content-header" style="height: 70px; width:1280px;">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h3 style="font-family: fantasy; font-size: 20px; margin-left: 3px;"><span style="font-size: 45px;">FMS&nbsp;물류센터</span></h3>
          </div><!-- /.col -->
          <div class="col-sm-6" style="padding:15px;">
            <ol class="breadcrumb float-sm-right">
			            ...
			            <div class="media">
				              <div class="media-body">
				                <h3 class="dropdown-item-title">
				                 ${loginLogis.logis_name}(${loginLogis.logis_code})
				                </h3>
				                <p class="text-sm"><i class="fas fa-mobile-alt"></i>&nbsp;&nbsp;${loginLogis.logis_tel}</p>
				                <p class="text-sm"><i class="fas fa-building"></i>&nbsp;${loginLogis.logis_zip}&nbsp;${loginLogis.logis_addr}&nbsp;${loginLogis.logis_detail_addr}</p>
			              	  <a href="<%=request.getContextPath() %>/logis/common/loginFormLogis.do" class="text-sm">LogOut</a>
			              	</div>
			           	 </div>
	            <!-- Message End -->
					</div>
				...
				<li style="padding-top:10px; font-size:14px;"><b>${loginLogis.logis_name}님</b> 환영합니다.</li>
            </ol>
        </div><!-- /.row -->
	</div>
</div>
