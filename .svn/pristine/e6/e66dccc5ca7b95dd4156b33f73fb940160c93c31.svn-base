...
public class HqWhVO {
	...
	private String return_code;			//반품코드
	private String sup_goods_code;		//공급업체물품코드
	private String hq_code;				//본사코드
	private String sup_goods_name;		//공급업체물품명
	private int return_goods_stock;		//반품물품재고량
	...
	public int getReturn_goods_stock() {
		return return_goods_stock;
	}
	public void setReturn_goods_stock(int return_goods_stock) {
		this.return_goods_stock = return_goods_stock;
	}
