...
<div>
 ...
 <div title="" class="XNbv3" style="position: absolute; overflow: visible; box-sizing: content-box !important; cursor: inherit; z-index: 1; left: 319px; top: 52px; transform: translate3d(-16px, -100%, 0px);"><div class="_type_surface_marker _1WYpV ui_control_parent_container_align_nxpcloc ui_control_parent_container_align_hover _ui_control_target" style="cursor: pointer;"><div class="AlLL9"><div class="_3_WU1"><div class="s4mo8"><div class="_1dfvP"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" class="_1BVfA"><path d="M13 5a6.57 6.57 0 0 0-5.5 10.1l5.1 6.7c.2.2.5.2.7 0l5.1-6.7c.7-1.1 1-2.3 1-3.6A6.4 6.4 0 0 0 13 5zm0 8c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"></path></svg></div><div class="_2sGoL"><div class="_8hoRl"><span class="_2CStP">스타벅스 대전판암DT점</span></div></div></div></div><div class="A5m1w"></div></div></div></div>
