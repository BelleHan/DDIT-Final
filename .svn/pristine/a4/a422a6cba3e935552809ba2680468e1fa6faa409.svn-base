	...
	<div class="row">
		...
		<div class="col-4 column" >
            <div class="card text-white bg-primary mb-3 no-move">
				<div class="card-header">Header<i class="fas fa-thumbs-up"></i> 추천발주</div>
				<div class="card-body">
...
<!-- 		</div> -->
		...
		<!-- 각 카드 리스트 박스 -->
				<div class="row column" style="padding-top:5px;">
               	  <h3 class="card-title col-sm-8">발주목록</h3>
				  <button type="button" class="btn btn-primary btn-xs float-right col-sm-4" onclick="Order();">발주요청</button>
				</div>
	            ...
	            <div class="row">
	            	...
	            	<div class="col-sm-8" style="padding-left: 20px;text-align: right;">
		     			<table class="float-right" style="padding-right:10px;font-size: 13px;">
							<tr  style="width :300px;">
...
/*		
		var data ={
			laca : $("#idLaca option:selected").val(),
			smca : $("#idSmca option:selected").val(),
			keword : $("#keyword").val()
		};
*/		
