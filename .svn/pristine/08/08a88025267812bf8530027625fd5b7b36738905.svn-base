...
<div class="content-header" style="height: 70px; width:1280px;">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h3 style="font-family: fantasy; font-size: 20px; margin-left: 3px;"><span style="font-size: 45px;">FMS&nbsp;공급업체</span></h3>
          </div><!-- /.col -->
            ...
            <ol class="breadcrumb float-sm-right">
	            ...
	            <!-- Message Start -->
			              <div class="media-body">
			                ...
			                ${loginSup.sup_name }(${loginSup.sup_code })
			                </h3>
			               <p class="text-sm"><i class="fas fa-mobile-alt"></i>&nbsp;&nbsp;${loginSup.sup_tel}</p>
			               <p class="text-sm"><i class="fas fa-building"></i>&nbsp;${loginSup.sup_zip}&nbsp;${loginSup.sup_addr}&nbsp;${loginSup.sup_detail_addr}</p>
	                       <p><a href="<%=request.getContextPath() %>/sup/common/loginFormSup.do" class="text-sm">LOGOUT</a></p>
			              </div>
	            <!-- Message End -->
					</div>
				...
				<li style="padding-top:10px; font-size:14px;"><b>${loginSup.sup_name}님</b> 환영합니다.</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
</div>
<!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color:#DF7401 !important; height: 50px;">
